...
export const DD = () => {
  return (
    <div className="bg-[#0D0421]   h-[100%] md:flex flex-col justify-center items-center pb-[20%] hidden  ">
    ...
    <section className="bg-[#00000023] flex flex-col   w-full mb-[10%]">
     ...
     <button className='text-white text-lg  ml-2 mt-2 font-medium'>Back</button>
      ...
      <br/>
      <h1 className='font-thin text-white text-start text-5xl ml-[10px] lg:text-5xl '>DRAGONES DORADOS</h1>
      <p className='font-thin text-white text-start text-xl ml-[10px] '>Wordpress website for which i was asked to make several changes
    and updates</p>
    <br/>
    <p className='font-thin text-white  text-start text-md ml-[10px] '>Wordpress, Pagelayer, PHP</p>
    <div className=' border-0 border-[#fffffffa] bg-[#fff] text-start  w-full h-[1px] '></div>
      <br/>
    <button className='bg-white ml-[10px] flex justify-center items-center w-[100px] h-[30px] font-thin rounded-sm text-md lg:text-lg hover:bg-transparent hover:text-white hover:border hover:border-[#fff] '> <MdRemoveRedEye className='h-[20px] w-[20px] mr-[2px] hover:text-white'/> Website</button>
      </section>
