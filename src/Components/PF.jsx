...
export const PF = () => {
 /*  bg-[#0D0421]  */
  return (
  <div className="bg-[#0D0421]   h-[100%] flex flex-col justify-center items-center pb-[10%]  ">

  <section className="bg-[#00000023] flex flex-col  ml-[10px]  mb-[10%] w-[100vw]">
      <Link to='/'>
 <button className='text-white text-lg  ml-2 mt-2 font-medium'>Back</button>
  ...
  <br/>
  <h1 className='font-thin text-white text-start ml-6 text-4xl  w-full '>PURA FICCION</h1>
  <p className='font-thin text-white text-start ml-6 text-md sm:text-lg'>Journalistic blog where i dedicated myself to developing and capturing
the frontend from layout prototypes</p>
<br/>
<p className='font-thin text-white  text-start text-sm ml-6'>React.js, Vite, Tailwind CSS, Redux</p>
