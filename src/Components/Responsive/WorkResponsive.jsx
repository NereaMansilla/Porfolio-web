...
export const WorkResponsive = () => {
  return (
    <section className="h-full bg-gradient-to-b bg-[#210D42] pt-[20%]  flex flex-col justify-center items-center" id="Work">
       ...
       <div className='bg-[#78389F] w-[350px] h-[300px] rounded-lg flex justify-center items-center '>
        <img src={PF} className="object-cover w-[300px] h-[250px]" alt="puraFiccion" />
       </div>
...
<br/>
       <div className='bg-[#78389F] w-[350px]  h-[300px] rounded-lg flex justify-center items-center  '>
        <img src={DD} className="object-cover w-[300px] h-[250px] " alt="puraFiccion" />
       </div>
       <div className='w-[350px]'>
